...
__global__ static void GINTint2e_jk_kernel1010(JKMatrix jk,
    ...
    for (i_dm = 0; i_dm < n_dm; ++i_dm) {
        if (vj != NULL) {
            ...
            reduce(gout0 * d_0 + gout1 * d_1 + gout2 * d_2,
                vj + (k0 + 0) + nao * (l0 + 0));
            reduce(gout3 * d_0 + gout4 * d_1 + gout5 * d_2,
                vj + (k0 + 1) + nao * (l0 + 0));
            reduce(gout6 * d_0 + gout7 * d_1 + gout8 * d_2,
                vj + (k0 + 2) + nao * (l0 + 0));
            // ijkl,kl->ij
            d_0 = dm[(k0 + 0) + nao * (l0 + 0)];
            d_1 = dm[(k0 + 1) + nao * (l0 + 0)];
            d_2 = dm[(k0 + 2) + nao * (l0 + 0)];
            reduce(gout0 * d_0 + gout3 * d_1 + gout6 * d_2,
                vj + (i0 + 0) + nao * (j0 + 0));
            reduce(gout1 * d_0 + gout4 * d_1 + gout7 * d_2,
                vj + (i0 + 1) + nao * (j0 + 0));
            reduce(gout2 * d_0 + gout5 * d_1 + gout8 * d_2,
                vj + (i0 + 2) + nao * (j0 + 0));
            vj += nao2;
        }
        if (vk != NULL) {
            ...
            reduce(gout3 * d_0, vk + (i0 + 0) + nao * (k0 + 1));
            reduce(gout4 * d_0, vk + (i0 + 1) + nao * (k0 + 1));
            reduce(gout5 * d_0, vk + (i0 + 2) + nao * (k0 + 1));
            reduce(gout6 * d_0, vk + (i0 + 0) + nao * (k0 + 2));
            reduce(gout7 * d_0, vk + (i0 + 1) + nao * (k0 + 2));
            reduce(gout8 * d_0, vk + (i0 + 2) + nao * (k0 + 2));
            // ijkl,jk->il
...
__global__ static void GINTint2e_jk_kernel1011(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (i_dm = 0; i_dm < n_dm; ++i_dm) {
        if (vj != NULL) {
            ...
            reduce(gout6 * d_0 + gout7 * d_1 + gout8 * d_2,
                vj + (k0 + 2) + nao * (l0 + 0));
            reduce(gout9 * d_0 + gout10 * d_1 + gout11 * d_2,
                vj + (k0 + 0) + nao * (l0 + 1));
            reduce(gout12 * d_0 + gout13 * d_1 + gout14 * d_2,
                vj + (k0 + 1) + nao * (l0 + 1));
            reduce(gout15 * d_0 + gout16 * d_1 + gout17 * d_2,
                vj + (k0 + 2) + nao * (l0 + 1));
            reduce(gout18 * d_0 + gout19 * d_1 + gout20 * d_2,
                vj + (k0 + 0) + nao * (l0 + 2));
            reduce(gout21 * d_0 + gout22 * d_1 + gout23 * d_2,
                vj + (k0 + 1) + nao * (l0 + 2));
            reduce(gout24 * d_0 + gout25 * d_1 + gout26 * d_2,
                vj + (k0 + 2) + nao * (l0 + 2));
            // ijkl,kl->ij
            d_0 = dm[(k0 + 0) + nao * (l0 + 0)];
            d_1 = dm[(k0 + 1) + nao * (l0 + 0)];
        ...
        if (vk != NULL) {
            ...
            reduce(gout0 * d_0 + gout9 * d_1 + gout18 * d_2,
                vk + (i0 + 0) + nao * (k0 + 0));
            reduce(gout1 * d_0 + gout10 * d_1 + gout19 * d_2,
                vk + (i0 + 1) + nao * (k0 + 0));
            reduce(gout2 * d_0 + gout11 * d_1 + gout20 * d_2,
                vk + (i0 + 2) + nao * (k0 + 0));
            reduce(gout3 * d_0 + gout12 * d_1 + gout21 * d_2,
                vk + (i0 + 0) + nao * (k0 + 1));
            reduce(gout4 * d_0 + gout13 * d_1 + gout22 * d_2,
                vk + (i0 + 1) + nao * (k0 + 1));
            reduce(gout5 * d_0 + gout14 * d_1 + gout23 * d_2,
                vk + (i0 + 2) + nao * (k0 + 1));
            reduce(gout6 * d_0 + gout15 * d_1 + gout24 * d_2,
                vk + (i0 + 0) + nao * (k0 + 2));
            reduce(gout7 * d_0 + gout16 * d_1 + gout25 * d_2,
                vk + (i0 + 1) + nao * (k0 + 2));
            reduce(gout8 * d_0 + gout17 * d_1 + gout26 * d_2,
                vk + (i0 + 2) + nao * (k0 + 2));
            // ijkl,jk->il
            d_0 = dm[(j0 + 0) + nao * (k0 + 0)];
            d_1 = dm[(j0 + 0) + nao * (k0 + 1)];
            ...
            reduce(gout2 * d_0 + gout5 * d_1 + gout8 * d_2,
                vk + (i0 + 2) + nao * (l0 + 0));
            reduce(gout9 * d_0 + gout12 * d_1 + gout15 * d_2,
                vk + (i0 + 0) + nao * (l0 + 1));
            reduce(gout10 * d_0 + gout13 * d_1 + gout16 * d_2,
                vk + (i0 + 1) + nao * (l0 + 1));
            reduce(gout11 * d_0 + gout14 * d_1 + gout17 * d_2,
                vk + (i0 + 2) + nao * (l0 + 1));
            reduce(gout18 * d_0 + gout21 * d_1 + gout24 * d_2,
                vk + (i0 + 0) + nao * (l0 + 2));
            reduce(gout19 * d_0 + gout22 * d_1 + gout25 * d_2,
                vk + (i0 + 1) + nao * (l0 + 2));
            reduce(gout20 * d_0 + gout23 * d_1 + gout26 * d_2,
                vk + (i0 + 2) + nao * (l0 + 2));
            // ijkl,il->jk
            d_0 = dm[(i0 + 0) + nao * (l0 + 0)];
            d_1 = dm[(i0 + 1) + nao * (l0 + 0)];
...
__global__ static void GINTint2e_jk_kernel1100(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (i_dm = 0; i_dm < n_dm; ++i_dm) {
        if (vj != NULL) {
            ...
            reduce(gout3 * d_0, vj + (i0 + 0) + nao * (j0 + 1));
            reduce(gout4 * d_0, vj + (i0 + 1) + nao * (j0 + 1));
            reduce(gout5 * d_0, vj + (i0 + 2) + nao * (j0 + 1));
            reduce(gout6 * d_0, vj + (i0 + 0) + nao * (j0 + 2));
            reduce(gout7 * d_0, vj + (i0 + 1) + nao * (j0 + 2));
            reduce(gout8 * d_0, vj + (i0 + 2) + nao * (j0 + 2));
            vj += nao2;
        }
        if (vk != NULL) {
            // ijkl,jl->ik
...
__global__ static void GINTint2e_jk_kernel1110(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ static void GINTint2e_jk_kernel2000(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (i_dm = 0; i_dm < n_dm; ++i_dm) {
        ...
        if (vk != NULL) {
            ...
            // ijkl,jk->il
            d_0 = dm[(j0 + 0) + nao * (k0 + 0)];
            reduce(gout0 * d_0, vk + (i0 + 0) + nao * (l0 + 0));
            reduce(gout1 * d_0, vk + (i0 + 1) + nao * (l0 + 0));
            reduce(gout2 * d_0, vk + (i0 + 2) + nao * (l0 + 0));
            reduce(gout3 * d_0, vk + (i0 + 3) + nao * (l0 + 0));
            reduce(gout4 * d_0, vk + (i0 + 4) + nao * (l0 + 0));
            reduce(gout5 * d_0, vk + (i0 + 5) + nao * (l0 + 0));
            // ijkl,il->jk
            d_0 = dm[(i0 + 0) + nao * (l0 + 0)];
            d_1 = dm[(i0 + 1) + nao * (l0 + 0)];
            d_2 = dm[(i0 + 2) + nao * (l0 + 0)];
...
__global__ static void GINTint2e_jk_kernel2010(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ static void GINTint2e_jk_kernel2100(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ static void GINTint2e_jk_kernel3000(JKMatrix jk,
    BasisProdOffsets offsets, GINTEnvVars envs, BasisProdCache bpcache) {
    int ntasks_ij = offsets.ntasks_ij;
    long ntasks = ntasks_ij * offsets.ntasks_kl;
    long task_ij = blockIdx.x * blockDim.x + threadIdx.x;
    ...
    for (i_dm = 0; i_dm < n_dm; ++i_dm) {
        ...
        if (vk != NULL) {
            ...
            reduce(gout4 * d_0, vk + (i0 + 4) + nao * (l0 + 0));
            reduce(gout5 * d_0, vk + (i0 + 5) + nao * (l0 + 0));
            reduce(gout6 * d_0, vk + (i0 + 6) + nao * (l0 + 0));
            reduce(gout7 * d_0, vk + (i0 + 7) + nao * (l0 + 0));
            reduce(gout8 * d_0, vk + (i0 + 8) + nao * (l0 + 0));
            reduce(gout9 * d_0, vk + (i0 + 9) + nao * (l0 + 0));
            // ijkl,il->jk
            d_0 = dm[(i0 + 0) + nao * (l0 + 0)];
            d_1 = dm[(i0 + 1) + nao * (l0 + 0)];
            d_2 = dm[(i0 + 2) + nao * (l0 + 0)];
